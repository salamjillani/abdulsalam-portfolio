...
export const EXPERIENCES = [
   {
    ...
    role: "Full-Stack Developer | Level 2 Seller",
    company: "Fiverr",
    description: `Providing professional full-stack web development services using the MERN stack, collaborating with international clients to deliver responsive and high-quality web applications.`,
